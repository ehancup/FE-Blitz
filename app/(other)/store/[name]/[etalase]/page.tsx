...
const Page = () => {
  ...
  const { useProductByStoreAndEtalase } = useProductModule();
  const {
    data,
    isLoading,
    handlePage,
  ...
  return (
    <div className="flex flex-col">
      ...
      {isLoading ? (
        ...
        <div className="w-full py-10 flex justify-center rounded-md border border-base-200/50 mt-5">
          <span className="">no item</span>
        </div>
      )}
